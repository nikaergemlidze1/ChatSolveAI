...
def render_admin(sidebar_slot, main_slot):
    ...
    with main_slot:
        ...
        st.markdown(
            "<style>"
            ".st-key-admin_grid [data-testid='stMetric']{"
            ...
            ".st-key-admin_grid [data-testid='stMetric']:hover{"
            "transform:translateY(-2px);"
            "box-shadow:0 6px 24px rgba(79,139,249,.12);"
            "border-color:rgba(79,139,249,.25)}"
            ".st-key-admin_grid [data-testid='stMetricLabel']{"
            "color:#7a8190!important;font-size:.7rem!important;"
            "letter-spacing:.08em;text-transform:uppercase;font-weight:600!important}"
            ".st-key-admin_grid [data-testid='stMetricValue']{"
            "font-family:var(--font-display)!important;"
            "font-size:1.85rem!important;font-weight:600!important;"
            "color:#E5E7EB!important;text-shadow:0 0 14px rgba(79,139,249,.22)}"
            ".st-key-admin_grid h3{font-family:var(--font-display)!important;"
            "font-weight:600;letter-spacing:.01em;color:#E5E7EB;"
            "margin:.4rem 0 1rem!important;font-size:1.1rem}"
