...
# ══════════════════════════════════════════════
# Render Chat (Admin Dashboard lives in pages/2_📊_Admin_Dashboard.py
# so each page runs as its own script execution — Streamlit cleanly
# unmounts the inactive page's DOM on navigation, no JS sweep
# required).
# ══════════════════════════════════════════════
with st.sidebar:
    sidebar_view = st.container(key="view_sb_chat")
main_view = st.container(key="view_main_chat")
