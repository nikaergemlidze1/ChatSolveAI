...
[class*='st-key-chatmsg-user'] [data-testid='stChatMessage']{background:rgba(79,139,249,.10)!important;border:1px solid rgba(79,139,249,.22)!important;border-left:3px solid #4F8BF9!important;backdrop-filter:blur(10px) saturate(140%)!important;-webkit-backdrop-filter:blur(10px) saturate(140%)!important;animation:bubbleInRight .42s cubic-bezier(.16,1,.3,1) both}
[class*='st-key-chatmsg-asst'] [data-testid='stChatMessage']{background:rgba(20,24,32,.45)!important;border:1px solid rgba(142,107,255,.18)!important;border-left:3px solid rgba(142,107,255,.55)!important;backdrop-filter:blur(10px) saturate(140%)!important;-webkit-backdrop-filter:blur(10px) saturate(140%)!important;animation:bubbleInLeft .42s cubic-bezier(.16,1,.3,1) both}
...
@keyframes bubbleInRight{0%{opacity:0;transform:translateX(14px) translateY(8px);filter:drop-shadow(0 0 0 rgba(79,139,249,0))}55%{filter:drop-shadow(0 0 16px rgba(79,139,249,.45))}100%{opacity:1;transform:translateX(0) translateY(0);filter:drop-shadow(0 0 0 rgba(79,139,249,0))}}
@keyframes bubbleInLeft{0%{opacity:0;transform:translateX(-14px) translateY(8px);filter:drop-shadow(0 0 0 rgba(142,107,255,0))}55%{filter:drop-shadow(0 0 16px rgba(142,107,255,.45))}100%{opacity:1;transform:translateX(0) translateY(0);filter:drop-shadow(0 0 0 rgba(142,107,255,0))}}
